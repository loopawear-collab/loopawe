...
function safeCartItemFromOrderItem(it: Order["items"][number]): Partial<CartItem> & { name: string; price: number } {
  return {
    name: it.name ?? "Item",
                    ...
                    >
                      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="flex items-center justify-between gap-4 md:justify-end">
                            ...
                            onClick={() => {
                              ...
                              try {
                                ...
                                for (const it of items) {
                                  const payload = safeCartItemFromOrderItem(it);
                                  addToCart(payload);
                                }
                          ...
                          >
                            {busyOrderId === o.id ? "Bezig…" : "Opnieuw bestellen"}
                          </button>
                        </div>
                      </div>
                    </div>
